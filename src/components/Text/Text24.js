...
import { autobuzew } from '../../mockData/mockData';
import './Text.css'
...
const Text_ceva24 = () => {
  ...
  return (
    <div>
      <br></br>
      <br></br>
      <div className='text_peste_tot'>Numarul de autobuze care trec in intersectie in fiecare ora in zilele de weekend</div>     
      <br></br>
      <div className={"denis"}>
