...
import { masiniPeOra } from '../../mockData/mockData';
import './Text.css'

const Text_ceva = () => {

  const getTextLaLiber = (numar) => numar >= 300 ? 'Aici este o ora de varf si recomandam amplasarea unui echipaj de politie' : 'Nu este ora de varf si recomandam o semaforizare in favoarea pietonilor';

  return (
    <div>
      <br></br>
      <br></br>
      <div className='text_peste_tot'>Numarul de masini care trec in intersectie in fiecare ora in zilele lucratoare</div>
      <br></br>
      <div className={"denis"}>
